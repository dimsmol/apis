...
var MethodMapper = function (handlers) {
	...
	if (httpMethods.GET && !httpMethods.HEAD) {
		// add HEAD as a GET copy if not explicitly specified
		// TODO provide a way to turn off this feature
		httpMethods.HEAD = true;
		this.map.HEAD = this.map.GET;
	}
