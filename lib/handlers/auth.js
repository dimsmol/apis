...
Auth.prototype.isAllowedProvider = function (ctx, authData, provider) {
	...
	return allowedProviderTypesDict == null || provider.type in allowedProviderTypesDict;
};
...
Auth.prototype.onAuthResult = function (ctx, provider, result) {
	...
	if (this.authorizationFunc != null) {
		var self = this;
		this.authorizationFunc(ctx, errh(function (isAuthorized) {
...
Auth.prototype.restrictTo = function (types) {
	this.options.allowedProviderTypes = types;
	this.options.allowedProviderTypesDict = (types == null ? null : types.map(function (prev, curr) { prev[curr] = true; return prev; }, {}));
	return this;
};
