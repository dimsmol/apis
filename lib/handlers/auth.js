...
Auth.prototype.handleRequest = function (ctx) {
	...
	if (data != null) {
		...
		if (authResult != null) {
			...
			this.checkAuthResult(ctx, authResult);
...
Auth.prototype.checkAuthResult = function (ctx, authResult) {
};

Auth.prototype.checkCtxAuth = function (ctx, auth) {
};
