...
WebError.prototype.isTransportLevel = false;
...
RequestEntityTooLarge.prototype.isTransportLevel = true; // because connection usually will be dropped
...
RequestEntityTooLarge.prototype.getDetails = function (isDebug) {
	...
	if (this.maxSize != null) {
		result.maxSize = this.maxSizemaxSize;
	}
	return result;
};
