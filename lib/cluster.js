...
Cluster.prototype.startMaster = function () {
	this.setupMaster();
	this.createCheckers();
	this.initListeners();
	this.forkWorkers();
...
Cluster.prototype.setupMaster = function () {
	...
	if (masterSettings != null) {
		...
		if (masterSettings.argsFunc != null) {
			settings.args = masterSettings.argsFunc(this);
		}
